...
QUERIES = [
    ...
    ("calendar", "when are the mid sem exams"),
    ("calendar", "list the holidays"),
    ("calendar", "when does registration close"),
    ("calendar", "when is diwali"),
    ("calendar", "how many teaching days"),
